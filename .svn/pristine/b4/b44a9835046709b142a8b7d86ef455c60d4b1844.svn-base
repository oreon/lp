...
public class PowerOfAttorneys {
    ...
    public PowerOfAttorneys(String clientName, String startDate, Boolean familyMember, String periodFrom, String periodTo, String purpose, Boolean noticeToClient, Boolean alreadyActing) {
